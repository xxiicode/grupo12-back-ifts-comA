...
// =======================================
router.get("/api", verificarToken, autorizarRoles("admin", "coordinador"), async (req, res) => {
  try {
...
router.get("/api/:id", verificarToken, autorizarRoles("admin", "coordinador"), async (req, res) => {
  try {
